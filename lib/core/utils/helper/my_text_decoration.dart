...
abstract final class MyTextFieldDecoration{
  ...
  static InputDecoration defaultDecoration(BuildContext context,[IconData? prefixIcon]) {
    return InputDecoration(
      ...
      prefixIcon: prefixIcon == null 
        ? null 
        : Icon(prefixIcon, color: Theme.of(context).primaryColor.withValues(alpha: 0.8)),
