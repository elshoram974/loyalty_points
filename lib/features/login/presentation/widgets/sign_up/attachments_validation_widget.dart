...
class AttachmentsValidationWidget extends StatefulWidget {
  ...
  @override
  State<AttachmentsValidationWidget> createState() => _AttachmentsValidationWidgetState();
}

class _AttachmentsValidationWidgetState extends State<AttachmentsValidationWidget> {
  ...
  Widget build(BuildContext context) {
    return FormField<List<XFile?>>(
      ...
      validator: (files) {
        if(files?.isNotEmpty != true || files?.contains(null) == true) return widget.errorMessage;
        return null;
      },
      builder: (state) {
                          ...
                          : Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: GestureDetector(
                                ...
                                child: const Padding(
                                  padding: EdgeInsets.all(AppConst.paddingExtraSmall),
                                  child: Icon(Icons.delete_forever, size: 18, color: Colors.red),
                                ),
                              ),
                            ),
                          ]),
