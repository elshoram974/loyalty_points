...
import '../../../dashboard/presentation/widgets/cancel_confirm_buttons.dart';
    ...
    return CustomScaffold(
        ...
        body: ListView(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: AppConst.paddingDefault, vertical: AppConst.paddingDefault),
              child: AuthField(
